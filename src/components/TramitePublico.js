// src/components/TramitePublico.js
// Pantalla de "Trámite Público" con animación, mensaje y área de imagen
import { EmpanadaBanner } from './EmpanadaBanner.js';

export function TramitePublico() {
  const container = document.createElement('div');
  container.id = 'tramitepublico-container';
  ...
  img.alt = 'Imagen de trámite público';
  img.style.cssText = `
    max-width: 100%;
    max-height: 100%;
    object-fit: contain;
