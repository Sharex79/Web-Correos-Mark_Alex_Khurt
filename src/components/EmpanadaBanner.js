export function EmpanadaBanner() {
  ...
  // Retornar un elemento vacío para el main.js
...
function mostrarBanner() {
  ...
  banner.innerHTML = `
    ...
    <div class="empanadas-banner-inner">
            <img src="/Empanada.png" alt="Empanadas" class="empanadas-banner-img"/>
  ...
  document.getElementById('mas-informacion').onclick = () => {
    window.open('/Legalidades/Política-Cookies.html', '_blank');
  };
}
