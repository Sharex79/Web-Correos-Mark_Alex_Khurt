// src/components/GestionAduanera.js
// Pantalla de "Gestión Aduanera" con animación, mensaje y área de imagen
import { EmpanadaBanner } from './EmpanadaBanner.js';

export function GestionAduanera() {
  const container = document.createElement('div');
  container.id = 'gestionaduanera-container';
  ...
  img.alt = 'Imagen de gestión aduanera';
  img.style.cssText = `
    max-width: 100%;
    max-height: 100%;
    object-fit: contain;
